...
> **注意**
>
> これはAIによって生成された説明です。内容の正確性は保証されません。

CBEは、ブラウザー上でローカルファイルを編集できる軽量エディターです。インストール不要で、Chromeを搭載したパソコンだけでなく、Chromebookでも利用できます。

ファイルの内容はサーバーへ送信せず、対応ブラウザーのローカルファイル機能を使って読み書きします。
...
ブラウザーのタイトル、アプリ上部のロゴ、説明文を「CBE」に統一しました。Chromebookでも利用できるローカルエディターであることを説明に明記しています。
